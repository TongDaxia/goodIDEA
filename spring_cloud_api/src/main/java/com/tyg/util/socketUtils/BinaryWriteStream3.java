...
public class BinaryWriteStream3 {
	...
	public byte[] getContent() {
		byte[] data = getData();
		return ArrayUtils.subarray(data, Consts.BINARY_PACKLEN_LEN_2 + Consts.CHECKSUM_LEN, data.length);
	}
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		System.out.println("ISO-8859-1: " + new String(bytes, "ISO-8859-1").length());
